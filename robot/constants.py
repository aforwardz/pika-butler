...
CONFIG_PATH = os.path.expanduser(os.getenv("PIKA_CONFIG", "~/.pika"))
CONTRIB_PATH = os.path.expanduser(os.getenv("PIKA_CONFIG", "~/.pika/contrib"))
CUSTOM_PATH = os.path.expanduser(os.getenv("PIKA_CONFIG", "~/.pika/custom"))
